  ...
  */
    {
      ...
      'appium:deviceName': process.env.APPFLOW_DEVICE_NAME,
      'appium:platformName': process.env.APPFLOW_PLATFORM_NAME,
      'appium:platformVersion': process.env.APPFLOW_PLATFORM_VERSION,
      'appium:wdaLaunchTimeout': 600000,
      'appium:orientation': 'PORTRAIT',
      'appium:automationName': 'XCUITest',
      // The path to the app
      // 'appium:app': 'platforms/ios/build/app-debug.ipa',
      'appium:app': process.env.APPFLOW_PATH_TO_BINARY,
